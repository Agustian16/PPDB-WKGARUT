                            ...
                            <tbody>
                                <?php
                                    ...
                                    if($_POST['simpan']=="Update"){
                                        ...
                                        mysqli_query($GLOBALS["___mysqli_ston"], $sqlqwe);
                                        ?>
                                    ...
                                    switch ($_GET['tombol']) {
                                        case 'delete':
                                                ...
                                                mysqli_query($GLOBALS["___mysqli_ston"], $sqli);
                                                $sqlo="DELETE FROM peserta_pendaftar WHERE nisn=$_GET[adm_id]";
                                                mysqli_query($GLOBALS["___mysqli_ston"], $sqlo);
                                                $sqlp="DELETE FROM nilai_ijazah WHERE nisn=$_GET[adm_id]";
                                                mysqli_query($GLOBALS["___mysqli_ston"], $sqlp);
